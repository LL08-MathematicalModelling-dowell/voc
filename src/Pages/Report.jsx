...
//     try {
//       const response = await axios.get(`https://100035.pythonanywhere.com/addons/get-response/?scale_id=${scaleId}`);
...
//                   <MenuItem
//                     key={0}
//                     value={1} // Value for the last 24 hours
//                   >
//                     24 hours
//                   </MenuItem>
//                   <MenuItem
...
//                         <div className="hidden md:flex justify-center items-center mt-10 gap-9 flex-wrap mx-5 ">
//                           <Grid
//                             item
//                             xs={12}
//                             md={5}
...
//                 <div className="hidden md:flex justify-center items-center mt-10 gap-12">
//                   {selectedChannel.length < 1 || selectedInstance.length < 1 ? null : (
//                     <>
//                       <Grid
//                         item
